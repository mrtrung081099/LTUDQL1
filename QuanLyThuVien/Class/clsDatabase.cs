...
namespace QuanLyThuVien.Class
{
    class clsDatabase
    {
        ...
        string strConnect = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Trung\Desktop\QLTV\CSDL\Library.mdf;Integrated Security=True;Connect Timeout=30";
